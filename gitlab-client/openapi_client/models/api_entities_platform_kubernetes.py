...
class APIEntitiesPlatformKubernetes(BaseModel):
    ...
    authorization_type: Optional[StrictStr] = None
    ca_cert: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["api_url", "namespace", "authorization_type", "ca_cert"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorization_type": obj.get("authorization_type"),

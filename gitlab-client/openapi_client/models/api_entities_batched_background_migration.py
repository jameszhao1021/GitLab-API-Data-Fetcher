...
class APIEntitiesBatchedBackgroundMigration(BaseModel):
    ...
    job_class_name: Optional[StrictStr] = None
    table_name: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    progress: Optional[Union[StrictFloat, StrictInt]] = None
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "job_class_name", "table_name", "status", "progress", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "job_class_name": obj.get("job_class_name"),

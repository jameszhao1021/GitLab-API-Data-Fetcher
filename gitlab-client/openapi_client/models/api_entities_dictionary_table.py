...
class APIEntitiesDictionaryTable(BaseModel):
    ...
    feature_categories: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["table_name", "feature_categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feature_categories": obj.get("feature_categories")
        })
        return _obj

...
class PostApiV4BroadcastMessagesRequest(BaseModel):
    """
    PostApiV4BroadcastMessagesRequest
    """ # noqa: E501
    message: StrictStr = Field(description="Message to display")
    ...
    broadcast_type: Optional[StrictStr] = Field(default=None, description="Broadcast type. Defaults to banner")

...
class APIEntitiesBroadcastMessage(BaseModel):
    ...
    target_access_levels: Optional[StrictStr] = None
    target_path: Optional[StrictStr] = None
    broadcast_type: Optional[StrictStr] = None
    dismissable: Optional[StrictStr] = None
    active: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "message", "starts_at", "ends_at", "color", "font", "target_access_levels", "target_path", "broadcast_type", "dismissable", "active"]
